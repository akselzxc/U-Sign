            ...
            <div class="h-full flex flex-col gap-6 min-h-0">
                ...
                <header class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        ...
                        <p class="text-gray-500 mt-1 text-sm">Monitor authentication events and frontliner activity in real time.</p>
                    </div>
                    <!-- Actions -->
                    <div class="flex gap-3">
                        <button class="px-4 py-2 bg-white/80 border border-gray-200 rounded-lg text-gray-700 hover:bg-gray-50 font-medium transition shadow-sm flex items-center gap-2">
                    ...
                    <div class="flex flex-col md:flex-row gap-4 items-stretch md:items-center">
                        <div class="flex-1 relative">
                            ...
                            <input
                                ...
                                class="w-full pl-10 pr-4 py-2.5 border border-gray-300 text-gray-700 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition outline-none bg-white/60"
                            />
                        </div>
                        <div class="w-full md:w-48">
                            <select
                                v-model="filterRole"
                                class="w-full px-4 py-2.5 border border-gray-300 text-gray-700 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition bg-white/80 outline-none"
                            >
                ...
                <!-- Logs Table -->
                <div class="bg-white/90 backdrop-blur rounded-2xl shadow-md overflow-hidden border border-gray-100 flex-1 min-h-0">
                    <div class="overflow-x-auto h-full">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                ...
                                >
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-600">
                                        <span class="px-2 py-1 bg-gray-100 rounded-full text-[11px] font-medium text-gray-700 border border-gray-200 uppercase tracking-wide">
                                            {{ log.role }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900 font-semibold">{{ log.action }}</div>
                                        <div class="text-xs text-gray-500 mt-0.5">{{ log.description }}</div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <span
                                            :class="['inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold border uppercase tracking-wide', getStatusColor(log.status)]"
                                        >
                        ...
                        <div
                            ...
                            class="flex items-center justify-between border-t border-gray-200 bg-white/90 px-4 py-3 sm:px-6"
                        >
